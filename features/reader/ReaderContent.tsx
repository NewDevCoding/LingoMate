...
export default function ReaderContent({ article, selectedWord, onWordSelect, vocabularyMap, onVocabularyUpdate }: ReaderContentProps) {
  ...
  const [viewMode, setViewMode] = useState<'page' | 'sentence' | 'translation'>('page');
        ...
        <div style={styles.Footer}>
          <div style={styles.ViewToggleContainer}>
            <button
              style={{
                ...styles.ViewButton,
                ...(viewMode === 'page' ? styles.ViewButtonActive : {}),
              }}
            ...
            <button
              style={{
                ...styles.ViewButton,
                ...(viewMode === 'sentence' ? styles.ViewButtonActive : {}),
              }}
            ...
            <button
              style={{
                ...styles.ViewButton,
                ...(viewMode === 'translation' ? styles.ViewButtonActive : {}),
              }}
              onClick={() => setViewMode('translation')}
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M3 5h12M9 3v2M7 8h8M5 12h14M3 15h10M9 13v2M7 18h8M5 21h14" />
              </svg>
