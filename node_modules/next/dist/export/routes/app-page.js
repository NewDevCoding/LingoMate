...
async function exportAppPage(req, res, page, path, pathname, query, fallbackRouteParams, partialRenderOpts, htmlFilepath, debugOutput, isDynamicError, fileWriter, sharedContext) {
    ...
    try {
        ...
        if (!flightData) {
            ...
            if (!fallbackRouteParams || fallbackRouteParams.size === 0 || renderOpts.experimental.clientParamParsing) {
        ...
        return {
            ...
            cacheControl,
            fetchMetrics,
            renderResumeDataCache: renderResumeDataCache ? await (0, _resumedatacache.stringifyResumeDataCache)(renderResumeDataCache, renderOpts.experimental.cacheComponents) : undefined
        };
    } catch (err) {
