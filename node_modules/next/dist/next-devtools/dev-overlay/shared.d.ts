...
export declare function useErrorOverlayReducer(routerType: 'pages' | 'app', getOwnerStack: (error: Error) => string | null | undefined, isRecoverableError: (error: Error) => boolean): [OverlayState, import("react").ActionDispatch<[action: DispatcherEvent]>];
export {};
