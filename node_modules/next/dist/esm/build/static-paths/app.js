 ...
 */ function validateParams(page, regex, isRoutePPREnabled, childrenRouteParams, rootParamKeys, routeParams) {
    const valid = [];
 ...
 */ export async function buildAppStaticPaths({ dir, page, distDir, cacheComponents, authInterrupts, segments, isrFlushToDisk, cacheHandler, cacheLifeProfiles, requestHeaders, cacheHandlers, maxMemoryCacheSize, fetchCacheKeyPrefix, nextConfigOutput, ComponentMod, isRoutePPREnabled = false, buildId, rootParamKeys }) {
    ...
    if (hadAllParamsGenerated || isRoutePPREnabled) {
        ...
        filterUniqueParams(childrenRouteParamSegments, validateParams(page, regex, isRoutePPREnabled, childrenRouteParamSegments, rootParamKeys, paramsToProcess)).forEach((params)=>{
            let pathname = page;
