...
if (typeof handler !== 'function') {
    throw Object.defineProperty(new Error(`The ${isProxy ? 'Proxy' : 'Middleware'} "${page}" must export a ${isProxy ? '`proxy`' : '`middleware`'} or a \`default\` function`), "__NEXT_ERROR_CODE", {
        value: "E867",
        enumerable: false,
        configurable: true
    });
