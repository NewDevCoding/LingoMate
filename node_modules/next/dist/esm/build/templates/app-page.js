...
export async function handler(req, res, ctx) {
    ...
    const prerenderInfo = nextConfig.experimental.ppr && !nextConfig.experimental.cacheComponents && isInterceptionRouteAppPath(resolvedPathname) ? null : routeModule.match(resolvedPathname, prerenderManifest);
   ...
   */ const couldSupportPPR = checkIsAppPPREnabled(nextConfig.experimental.ppr);
    ...
    (supportsRSCForNavigations && getRequestMeta(req, 'onCacheEntryV2') ? // which will generate the RDC for the route. When resuming a Dynamic
    ...
    try {
        ...
        const responseGenerator = async ({ hasResolved, previousCacheEntry: previousIncrementalCacheEntry, isRevalidating, span, forceStaticRender = false })=>{
            ...
            supportsRSCForNavigations && process.env.NEXT_RUNTIME !== 'edge' && !minimalMode && incrementalCache && isDynamicRSCRequest && // We don't typically trigger an on-demand revalidation for dynamic RSC
        ...
        const handleResponse = async (span)=>{
            ...
            const onCacheEntry = supportsRSCForNavigations ? getRequestMeta(req, 'onCacheEntryV2') ?? getRequestMeta(req, 'onCacheEntry') : getRequestMeta(req, 'onCacheEntry');
            if (onCacheEntry) {
