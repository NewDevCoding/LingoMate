...
export async function getAppPageStaticInfo({ pageFilePath, nextConfig, isDev, page }) {
    var _nextConfig_experimental, // don't allow in `clientSegmentCache: 'client-only'` mode
    _nextConfig_experimental1;
    ...
    if ('unstable_prefetch' in config && (!((_nextConfig_experimental = nextConfig.experimental) == null ? void 0 : _nextConfig_experimental.cacheComponents) || ((_nextConfig_experimental1 = nextConfig.experimental) == null ? void 0 : _nextConfig_experimental1.clientSegmentCache) !== true)) {
        throw Object.defineProperty(new Error(`Page "${page}" cannot use \`export const unstable_prefetch = ...\` without enabling \`experimental.cacheComponents\` and \`experimental.clientSegmentCache\`.`), "__NEXT_ERROR_CODE", {
            value: "E796",
            enumerable: false,
            configurable: true
        });
