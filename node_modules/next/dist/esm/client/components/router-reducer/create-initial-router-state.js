...
import { createSeededPrefetchCacheEntry, STATIC_STALETIME_MS } from './prefetch-cache-utils';
import { PrefetchKind } from './router-reducer-types';
import { addRefreshMarkerToActiveParallelSegments } from './refetch-inactive-parallel-segments';
import { getFlightDataPartsFromPath } from '../../flight-data-helpers';
export function createInitialRouterState({ navigatedAt, initialFlightData, initialCanonicalUrlParts, initialParallelRoutes, location, couldBeIntercepted, postponed, prerendered }) {
    ...
    if (process.env.NODE_ENV !== 'development' && location) {
        ...
        createSeededPrefetchCacheEntry({
            ...
            data: {
                ...
                // fully static pages.
                staleTime: // In the old router, there was only a single configurable staleTime (experimental.staleTimes)
                ...
                prerendered && !process.env.__NEXT_CLIENT_SEGMENT_CACHE ? STATIC_STALETIME_MS : -1
            },
