...
export function navigateReducer(state, action) {
    ...
    if (process.env.__NEXT_CLIENT_SEGMENT_CACHE) {
        ...
        const result = navigateUsingSegmentCache(url, currentUrl, state.cache, state.tree, state.nextUrl, shouldScroll);
    ...
    return data.then(({ flightData, canonicalUrl: canonicalUrlOverride, postponed })=>{
        ...
        const onlyHashChange = !!hash && oldCanonicalUrl.split('#', 1)[0] === updatedCanonicalUrl.split('#', 1)[0];
        ...
        for (const normalizedFlightData of flightData){
            ...
            if (newTree !== null) {
                ...
                seedData && isRootRender && postponed) {
                    const task = startPPRNavigation(navigatedAt, new URL(oldCanonicalUrl, url.origin), currentCache, currentTree, treePatch, seedData, head, isHeadPartial, false, scrollableSegments);
                    if (task !== null) {
                        if (task.route === null) {
