...
export function getSegmentKeypath(fetchStrategy, route, cacheKey) {
    ...
    const isDynamic = fetchStrategy === FetchStrategy.Full || fetchStrategy === FetchStrategy.PPRRuntime || !route.isPPREnabled;
