...
function pingPPRSegmentRevalidation(now, task, currentSegment, route, routeKey, tree) {
    ...
    switch(revalidatingSegment.status){
        case EntryStatus.Empty:
            ...
            // upon completion.
            upsertSegmentOnCompletion(task.fetchStrategy, route, tree.cacheKey, spawnPrefetchSubtask(fetchSegmentOnCacheMiss(route, upgradeToPendingSegment(revalidatingSegment, FetchStrategy.PPR), routeKey, tree)));
            break;
        case EntryStatus.Pending:
            break;
        case EntryStatus.Fulfilled:
...
function pingFullSegmentRevalidation(now, route, currentSegment, tree, fetchStrategy) {
    ...
    if (revalidatingSegment.status === EntryStatus.Empty) {
        ...
        upsertSegmentOnCompletion(fetchStrategy, route, tree.cacheKey, waitForSegmentCacheEntry(pendingSegment));
