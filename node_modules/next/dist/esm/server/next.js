            ...
            this.serverPromise = this[SYMBOL_LOAD_CONFIG]().then(async (conf)=>{
                if (this.options.dev) {
                    if (conf.experimental.lockDistDir) {
                        const dir = path.resolve(/* turbopackIgnore: true */ this.options.dir || '.');
                        const distDir = path.join(/* turbopackIgnore: true */ dir, conf.distDir);
                        mkdirSync(distDir, {
                            recursive: true
                        });
                        this.lockfile = await Lockfile.acquireWithRetriesOrExit(path.join(/* turbopackIgnore: true */ distDir, 'lock'), 'next dev');
                    }
                } else {
