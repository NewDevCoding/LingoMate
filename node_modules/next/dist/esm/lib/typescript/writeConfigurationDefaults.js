...
export async function writeConfigurationDefaults(typescriptVersion, tsConfigPath, isFirstTimeSetup, hasAppDir, distDir, hasPagesDir) {
    ...
    if (!('include' in userTsConfig)) {
        ...
        suggestedActions.push(cyan('include') + ' was set to ' + bold(hasAppDir ? `['next-env.d.ts', '${nextAppTypes}', '**/*.mts', '**/*.ts', '**/*.tsx']` : `['next-env.d.ts', '**/*.mts', '**/*.ts', '**/*.tsx']`));
    } else if (hasAppDir) {
